$(function() {
  ...
  let name2Data = sessionStorage.getItem('name2');
  let display = [
    [],
    [],
    [],
  ...
  $.fn.createBord = function(){
    ...
    <div class="container">
      ...
      <div id="grille">
        ...
        <div class="trou" id="0" style="left: 15px; top: 15px;"></div>
        ...
        <div class="trou" id="1" style="left: 125px; top: 15px;"></div>
        ...
        <div class="trou" id="2" style="left: 235px; top: 15px;"></div>
        ...
        <div class="trou" id="3" style="left: 345px; top: 15px;"></div>
        ...
        <div class="trou" id="4" style="left: 455px; top: 15px;"></div>
        ...
        <div class="trou" id="5" style="left: 565px; top: 15px;"></div>
        ...
        <div class="trou" id="6" style="left: 675px; top: 15px;"></div>
  ...
  function askNames() {
    if (name1Data == null && name2Data == null || name1Data == null || name2Data == null) {
      name1 = prompt("Pseudo 1 : ");
      name2 = prompt("Pseudo 2 : ");
      while (name1 == "") {
        name1 = prompt("Pseudo 1 : ");
      }
      while (name2 == "") {
      ...
      name2Data = sessionStorage.getItem('name2');
  ...
  function flipCoin() {
    ...
    if (currPlayer == "jaune") {
      ...
      function add() {
        $('.popup').html("<section class='alert'><p><br>Les rouges commence !<br><img src=\"rouge.png\" style=\"width:90px; margin-top:10px\"></p></section>");
    ...
    function remove() {
      $('.popup').html("");
      currPlayer == "jaune" ? yellowNextCoin() : redNextCoin();
    }
  ...
  function appendWinDisplay() {
    if (currPlayer == "jaune") {
      $('.popup').html("<section class='alert2'><p>Les jaune ont gagné !<br><br><img src=\"tenor.gif\"><br><br><a href=\"one.html\"><button class=\"replay\" style\"background:#8c6cff;\">Rejouer</button></a><a href=\"index.html\"><button class=\"quit\" style\"background:#8c6cff; margin-left:-20px;\">Quitter</button></a></p></section>");
      disableClick();
      ...
      $('.popup').html("<section class='alert2'><p>Les rouge ont gagné !<br><br><img src=\"tenor.gif\"><br><br><a href=\"one.html\"><button class=\"replay\" style\"background:#8c6cff;\">Rejouer</button></a><a href=\"index.html\"><button class=\"quit\" style\"background:#8c6cff; margin-left:-20px;\">Quitter</button></a></p></section>");
      disableClick();
      $('.replay').click(function() {
        location.reload()
      });
  ...
  function appendNullDisplay(){
    $('.popup').html("<section class='alert2'><p>Match Nul !<br><br><img src=\"tenor.gif\"><br><br><a href=\"one.html\"><button class=\"replay\" style\"background:#8c6cff;\">Rejouer</button></a><a href=\"index.html\"><button class=\"quit\" style\"background:#8c6cff; margin-left:-20px;\">Quitter</button></a></p></section>");
    disableClick();
    $('.replay').click(function() {
      location.reload()
    });
  ...
  function nextPlayer() {
    if (currPlayer == "jaune") {
      function add() {
        $('.popup').html("<section class='alert'><p><br>Les rouges c'est votre tour !<br><img src=\"rouge.png\" style=\"width:90px; margin-top:10px\"></p></section>");
        $('.pseudo2').css('-webkit-animation', "neon1 0.4s ease-in-out infinite alternate");
        $('.pseudo1').css('animation', 'none');
