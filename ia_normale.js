$(function() {
          ...
          <div id="grille">
              ...
              <span class="close-ot-alert">
                <i class="fa fa-close"></i>
                  ...
                  <p>Clique dans cette zone pour faire tomber t'es jetons !</p>
              </div>
  ...
  //  token = 6
    ...
    let m = 4;
    let s = 3;
    for (let h = 0; h < 7; h++) { //vertical check for block yellow coin
      if (display[h][0] == "jaune" && display[h][1] == "jaune" && display[h][2] == "jaune") {
        if (display[h][0] == "jaune" && display[h][1] == "jaune" && display[h][2] == "jaune" && display[h][3] != "rouge")
          token = h
      }
      else if (display[h][1] == "jaune" && display[h][2] == "jaune" && display[h][3] == "jaune") {
        if (display[h][1] == "jaune" && display[h][2] == "jaune" && display[h][3] == "jaune" && display[h][4] != "rouge")
          token = h
      }
      else if (display[h][2] == "jaune" && display[h][3] == "jaune" && display[h][4] == "jaune") {
        if (display[h][2] == "jaune" && display[h][3] == "jaune" && display[h][4] == "jaune" && display[h][5] != "rouge")
          token = h
      }
    }
    for (let h = 0; h < 7; h++) { //horizontal win
      if (display[1][h] == "jaune" && display[2][h] == "jaune" && display[0][h] != "rouge" && display[3][h] != "rouge"){
      ...
      else if (display[2][h] == "jaune" && display[3][h] == "jaune" && display[1][h] != "rouge" && display[4][h] != "rouge"){
        rand = Math.floor(Math.random() * Math.floor(2));
        if (rand == 0)
          token = 1
        else
      ...
      else if (display[3][h] == "jaune" && display[4][h] == "jaune" && display[2][h] != "rouge" && display[5][h] != "rouge"){
        rand = Math.floor(Math.random() * Math.floor(2));
        if (rand == 0)
          token = 2
        else
      ...
      else if (display[4][h] == "jaune" && display[5][h] == "jaune" && display[3][h] != "rouge" && display[6][h] != "rouge"){
        rand = Math.floor(Math.random() * Math.floor(2));
        if (rand == 0)
          token = 3
        else
      ...
      else if (display[0][h] == "jaune" && display[1][h] == "jaune" && display[2][h] == "jaune") {
        if (display[0][h] == "jaune" && display[1][h] == "jaune" && display[2][h] == "jaune" && display[3][h] != "rouge")
          token = 3
      } else if (display[1][h] == "jaune" && display[2][h] == "jaune" && display[3][h] == "jaune") {
        if (display[1][h] == "jaune" && display[2][h] == "jaune" && display[3][h] == "jaune" && display[4][h] != "rouge")
          token = 4
      } else if (display[2][h] == "jaune" && display[3][h] == "jaune" && display[4][h] == "jaune") {
          if (display[2][h] == "jaune" && display[3][h] == "jaune" && display[4][h] == "jaune" && display[5][h] != "rouge")
            token = 5
      } else if (display[3][h] == "jaune" && display[4][h] == "jaune" && display[5][h] == "jaune") {
          if (display[3][h] == "jaune" && display[4][h] == "jaune" && display[5][h] == "jaune" && display[6][h] != "rouge")
            token = 6
      }
    }
/*
    for (let h = 0; h != 4; h++) { //vertical right win
      if (display[h][0] == "jaune" && display[j][1] == "jaune" && display[k][2] == "jaune") {
        win = true;
      } else if (display[h][1] == "jaune" && display[j][2] == "jaune" && display[k][3] == "jaune") {
        win = true;
      } else if (display[h][2] == "jaune" && display[j][3] == "jaune" && display[k][4] == "jaune") {
        win = true;
      } else if (display[h][3] == "jaune" && display[j][4] == "jaune" && display[k][5] == "jaune") {
        win = true;
      }
      j++;
      k++;
    ...
    for (let h = 6; h != 2; h--) { //vertical left win
      if (display[h][0] == "jaune" && display[p][1] == "jaune" && display[m][2] == "jaune") {
        win = true;
      } else if (display[h][1] == "jaune" && display[p][2] == "jaune" && display[m][3] == "jaune") {
        win = true;
      }
      if (display[h][2] == "jaune" && display[p][3] == "jaune" && display[m][4] == "jaune") {
        win = true;
      }
      p--;
      m--;
...
*/
  ...
  function appendWinDisplay() {
    if (currPlayer == "jaune") {
      $('.popup').html("<section class='alert2'><p>Les jaune ont gagné !<br><br><img src=\"tenor.gif\"><br><br><a href=\"ia_normale.html\"><button class=\"replay\" style\"background:#8c6cff;\">Rejouer</button></a><a href=\"index.html\"><button class=\"quit\" style\"background:#8c6cff; margin-left:-20px;\">Quitter</button></a></p></section>");
      disableClick();
      ...
      $('.popup').html("<section class='alert2'><p>Les rouge ont gagné !<br><br><img src=\"tenor.gif\"><br><br><a href=\"ia_normale.html\"><button class=\"replay\" style\"background:#8c6cff;\">Rejouer</button></a><a href=\"index.html\"><button class=\"quit\" style\"background:#8c6cff; margin-left:-20px;\">Quitter</button></a></p></section>");
      disableClick();
      $('.replay').click(function() {
        sessionStorage.setItem('replay', "1");
        location.reload()
